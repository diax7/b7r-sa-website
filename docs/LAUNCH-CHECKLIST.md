...
| 49 | The traced logo compared with the PNG in the header at 1440 and 390, and Sea mist with `resources/gradient/reference.png` (its deep bloom lightened from #00609b to #4f9cd7 so text reads on it) | Dhia | open | By eye; ADR-065 phase 1c and 1d |
