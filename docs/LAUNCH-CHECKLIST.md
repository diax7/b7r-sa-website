...
| 50 | IBM Plex Sans Arabic is under the OFL with the Reserved Font Name "Plex", and the served subsets keep the family name: rename the subset's family, or keep it | Dhia | open | `scripts/subset-fonts.sh`, `public/fonts/*-OFL.txt` |
