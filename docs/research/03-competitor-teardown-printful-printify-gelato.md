...
**1.1 Header / nav**
- Top level: **Products | Sell with Printful | Design creation | Resources | Pricing** · locale pill "US" (EN US/UK/CA, ES, FR, DE, IT, JA) · **"Get Started"** (→ /auth/register) · "Sign in". No currency switcher (set in dashboard).
- **Products** mega-menu: All products; Men's / Women's / Kids' clothing sub-lists; Hats; Accessories; Home & living; **Collections** (New, Bestsellers, Starter pack, Sportswear, Streetwear, Eco-friendly, Gifts, Fast delivery, Halloween, Back to school, Embroidery, All-over print…); **Brands** (33 blanks brands).
- **Sell with Printful**: Quick Stores; Platforms (Shopify, WooCommerce, Wix, Squarespace, BigCommerce, Etsy, Amazon, TikTok Shop, eBay… 22 partners); Sales channels; Branding options (white-label, custom packaging, inserts, inside labels); How Printful works; Switch to Printful.
- **Design creation**: techniques (DTG, Embroidery, All-over, DTFlex, knitting); Design Maker; Mockup Generator.
- **Resources**: Blog, Academy, Guides, Help Center, Store setup checklist, Demo, Podcast, Glossary; Tools (App, Etsy calculator, Background remover, Mockup maker); Partner programs; About.
- **Pricing**: Shipping & returns, Deals, Pricing, Memberships.

**1.2 Hero**
- Rotating headline (word-swap animation): "Unleash your inner brand" / "Bring your art to life" / "Where dreams meet reality" / "From idea to iconic" / "Less hustle. More passion."
- Sub: "Add your designs to hundreds of beautiful products, which we ship to your customers around the world."
- CTAs: **"Get started"** (primary) · **"Get enterprise support"** (secondary).
- Visual: video reel of real seller brands ending on a slot that reads **"Your future brand"**.
- Social proof: Trustpilot-style **"4.6 · 6,936 reviews"** and Shopify **"4.8 · 3,857 reviews"**; client logo wall (MTV, Dunkin', Spotify, Coca-Cola, NBC…); **"Trusted to deliver 143.9M items since 2013"**.

**1.3 Homepage sections in order**
1. Hero.
...
- Summary: **"In short: You design. You sell. Printful prints and ships – globally – with no inventory and no delays."**
- 5 steps: Design your products / Create your online store / List your products / Set up billing / Sample your creations.
...
**1.9 FAQ**: homepage none. How-it-works 8 Qs ("What does Printful do?", "How do I use Printful?", "Does Printful automatically fulfill orders?", "Can you sell directly from Printful?", "Where can I sell?", "How long does Printful take to ship?", "Does Printful ship for you?", "Does Printful ship worldwide?"); pricing 7; POD page 12.

**1.10 Blog / resources**: posts at `/blog/<slug>/`; sub-nav All posts | Beginner's handbook | Ecommerce holidays | Marketing tips | More; ~40-tag cloud; meta: tag · "9 min read" · date · author; lead magnet "2026 Ecommerce holiday calendar". Separate **Academy** (courses, video lessons, rewards points), **Guides** hub, Help Center, Podcast, Glossary. Footer pins 6 evergreen posts.

**1.11 Footer**: Sell with Printful · Create custom products · Explore · Resources · About Printful · Latest updates. Tagline "Fulfilling your ideas on demand" + "Trusted to deliver 143.4M items since 2013"; payment icons (Visa, Mastercard, Amex, PayPal, Apple Pay, Klarna…); carrier logos (USPS, DHL, FedEx, Asendia); 7 social icons; legal address.

**1.12 Design notes**: black wordmark on white; video-led, photography-heavy; dark sections for stats; large numerals; short copy per block; chat bubble bottom-right; live-order ticker on PDP; third-party rating logos for credibility. Long-form SEO pages sit below marketing pages, not on the homepage.
...
**2.1 Header / nav**
- **Catalog** (→ /app/products, the app) | **Pricing** | **How it works ▾** (How Printify works, POD 101, Resource Center) | **Solutions ▾** (Start selling: custom t-shirts/hoodies/mugs/embroidery/socks/branding/free designs · Features: Printify Choice, Enterprise, Express Delivery, Personalization, Pop-up Store · Integrations: Etsy, Shopify, TikTok, Amazon, All · Tools: Mockup Generator, Product Creator, AI Image Generator) | **Learn ▾** (Live Show + Webinars, Podcast, YouTube, Guides, Courses, Amplified conference) | **Services ▾** (Bulk orders, Transferring to Printify) | **Support ▾**.
- Right: **"Log in"** · **"Sign up"**. No language or currency switcher.
...
**2.12 Design notes**: Rebrand palette **Green #AEFF6E ("the color of profit"), Khaki #2F2E0C, Stone #FBFBF3** (warm off-white ground, near-black text, acid-green accents). Large display type. Seller-story photography. Material Symbols icons. Everything is chips, numbered steps, check-lists, carousels, calculators. Copy is very short; money words everywhere.

---

## 3. GELATO (https://www.gelato.com)
...
**3.12 Design notes**: black wordmark, white ground, pastel gradient banners, rounded tiles; Material Symbols; "▻" bullets; Storyblok-driven modular blocks reused verbatim across SEO pages; copy is the densest of the three; heavy promo-bar and geo-switch; header carries language+currency; app badges in footer.

---

## Patterns worth stealing (adapted for an Arabic-first Saudi POD site)

1. **Two-price product cards ("From X / From Y with Premium")** (Printify) → makes the upgrade tangible → Adapt only if B7R ever has tiers; otherwise show one honest base price.
2. **Inline "See how much you can make" calculator on homepage and pricing page** (Printify: product chips → "Sell it for" → "Daily sales" → monthly earnings) → converts "no upfront cost" into a number in 3 seconds → RTL version with product chips (تيشيرت، هودي…), inputs "سعر البيع" and "مبيعات يومية", output "أرباحك الشهرية التقديرية"; realistic Saudi retail defaults; footnote on VAT/shipping.
3. **Margin-first calculator variant** (cost + extra costs + desired margin % → retail price + profit) → matches how beginners think → Offer a toggle: "أدخل سعر البيع" vs "أدخل هامش الربح".
4. **Worked profit examples in copy** ("cost $8.80 → sell $14.67 → profit $5.87" at 40/50/60%) → concrete arithmetic beats adjectives → Three named products with real SAR numbers on category pages.
5. **Explicit profit equation as a design element** ("Printful price + Your profit margin = Retail price"; "Your profit = Retail price – Printful cost" as 4 numbered lines) → removes the #1 confusion (who pays whom, when) → Arabic three-tile equation "سعر بَحر + هامش ربحك = سعر البيع" with a 4-line money flow.
6. **Named, numbered how-it-works with one verb per step and a CTA per step** (Printify "Select → Create → Publish → Make money risk-free") → "اختر → صمّم → انشر → اربح" with per-step buttons; mirror connectors in RTL.
7. **Proof chips under the H1 + "no credit card" microcopy + third-party rating logo** (Printify "100% Free to use · 1300+ products · Global delivery", "4.8 on Shopify") → "مجاني 100% · بدون حد أدنى · توصيل لكل مدن المملكة" plus a real rating source (Salla App Store rating, Google reviews), never unattributed stars.
8. **Local-production stat trio** (Gelato "90% produced locally / 90% arrive within 5 days / 250+ partners") → speed and locality are the buying reason → "يُنتج في جدة · يصل خلال X أيام · تغطية كل مناطق المملكة"; carrier logos in the footer like Printful's USPS/DHL/FedEx.
9. **Live-order ticker and "X% recommend" on PDPs** (Printful) → social proof at the decision point → "آخر طلب من الدمام قبل 3 دقائق" (city-level only) once volume exists.
10. **Card badge vocabulary: Bestseller / New / Early Access / Eco-friendly** → fixed Arabic set: "الأكثر مبيعاً", "جديد", "وصول مبكر"; badge sits top-right in RTL.
11. **Integrations as grouped cards with one benefit line each, plus region tags** → Groups "منصات المتاجر" (Salla, Zid, Shopify) with tags like "متاح الآن" / "قريباً" and a one-line benefit ("سلة: مزامنة الطلبات تلقائياً خلال دقائق").
12. **Store-switching migration offer** (Gelato Velocity Switch, Printful "Switch to Printful", Printify "Transferring") → "انتقل إلى بحر" page for merchants currently on Printful/Printify.
13. **Resource Center with tabs (Blog | Guides | Webinars) plus topic hubs and an Academy** → `/blog/<category>/` clean paths, hubs, "أكاديمية بحر" of short Arabic videos; each post opens with "أهم النقاط" (Gelato's "Main takeaways").
14. **Footer as a second sitemap with payment + carrier badges** (Printful) → 5 columns, mada/Visa/Apple Pay/Tabby/Tamara icons, carrier logos, VAT + CR line, SBC badge, app-store badges.
15. **Audience switcher in the hero** (Gelato "For creators / For print producers") → Tabs "للمبدعين والمتاجر" / "للشركات والجهات" (bulk merch, corporate gifting), each with its own CTA.

## Anti-patterns to avoid

- **Nav that hides the catalog behind app login** (Printify's "Catalog" → app). Serve an SSR catalog with real prices; it is the biggest SEO surface.
