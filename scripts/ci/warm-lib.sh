...
WARM_URLS="/ /products /products/tee-essential /contact /blog/how-to-price-printed-tshirt-saudi /en /en/products/tee-essential /how-it-works /faq /privacy /en/compare-printful"
