...
- [ ] T511 Blog readers, routes and feed per locale; pagination, search index and fold,
  reading time and editorial rules per locale; translation pairs' hreflang.
- [ ] T512 Seed: the three Level 1 posts in English, hubs and author in English.
- [ ] T513 Tests and docs (ADR-043 amendment, BRD §6.11/§10.1 notes, IDEAS closed).
