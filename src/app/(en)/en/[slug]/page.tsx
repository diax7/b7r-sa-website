...
export const generateStaticParams = () => cmsSlugParams('en');

export async function generateMetadata({ params }: Params): Promise<Metadata> {
  return cmsSlugMetadata('en', (await params).slug);
}

export default async function PageRoute({ params }: Params) {
  return renderCmsSlug('en', (await params).slug, SITE_BLOCK_RENDERERS);
}
