 ...
 * so the caret sits correctly (BRD 3.12.5); `text-start` keeps the text at the start edge.
 */
export function Input({ invalid, className, ...rest }: InputProps) {
  return (
    <input
      ...
      className={cn(
        'h-11 w-full rounded-base border border-border bg-surface px-4 text-body text-text text-start placeholder:text-text-muted',
