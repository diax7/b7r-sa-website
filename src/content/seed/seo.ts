...
export const seo: PageSeo[] = [
  ...
  },
  {
    ...
    title: 'مدونة بحر',
    description:
      'أدلة عملية لبدء براندك وبيع المنتجات المطبوعة في السعودية: التسعير والربح وربط متجرك بسلة وزد وشوبيفاي.',
    updatedAt: '2026-09-13',
  },
  {
    route: '/terms',
    ...
    description:
      'شروط استخدام منصة بحر برنت: التسجيل والطلبات والأسعار والدفع وحقوق التصاميم والإلغاء.',
    updatedAt: '2026-09-13',
  },
  {
    route: '/shipping',
    ...
    description:
      'سياسة الشحن والتوصيل في بحر برنت داخل المملكة: التوصيل خلال 5 أيام، ومحاولات التسليم، والتعويض خلال 10 أيام من الاستلام.',
    updatedAt: '2026-09-13',
  },
  {
    route: '/privacy',
    title: 'سياسة الخصوصية',
    description: 'كيف نجمع بياناتك ونستخدمها ونحميها في بحر برنت، ومدة الاحتفاظ بها، وحقوقك عليها.',
    updatedAt: '2026-09-13',
  },
];
