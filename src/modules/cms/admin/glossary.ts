...
export const GLOSSARY: readonly GlossaryRow[] = [
  ...
  {
    area: 'inbox',
    en: 'booking (a consultation a merchant booked)',
    ar: 'حجز',
    latin: false,
    refused: ['طلب حجز', 'حجوزات مسبقة'],
    note: 'Plural «الحجوزات»; the entry after Messages in the inbox section, and the settings global.',
  },
  {
    area: 'inbox',
    en: 'consultation',
    ar: 'استشارة',
    latin: false,
    refused: ['جلسة استشارية', 'مكالمة تعريفية'],
    note: 'What the merchant books; the settings name it («استشارة مجانية، 30 دقيقة»).',
  },
  {
    area: 'inbox',
    en: 'appointment (a slot on the grid)',
    ar: 'موعد',
    latin: false,
    refused: ['فترة زمنية', 'خانة زمنية'],
    note: 'Plural «المواعيد»: the settings count appointments per day; a booking holds its appointment.',
  },
  {
    area: 'inbox',
    en: 'calendar owner (the host)',
    ar: 'صاحب التقويم',
    latin: false,
    refused: ['المضيف', 'مالك التقويم'],
    note: 'The Workspace account whose calendar the bookings write to (the settings field, the Test).',
  },
  {
    area: 'inbox',
    en: 'Meet link',
    ar: 'رابط Meet',
    latin: true,
    refused: ['رابط الاجتماع', 'رابط ميت'],
    note: 'Google creates it with the event; the row shows it, the reminder sends it.',
  },
  {
    area: 'inbox',
    en: 'booked',
    ...
    latin: false,
    refused: ['مؤكد', 'مؤكّد'],
    note: 'Green: the appointment stands.',
  },
  {
    area: 'inbox',
    en: 'rescheduled',
    ar: 'مُعاد جدولته',
    latin: false,
    refused: ['أعيد جدولته', 'مؤجل', 'مؤجّل'],
    note: 'Amber: the merchant moved it from the link in the e-mail.',
  },
  {
    area: 'inbox',
    en: 'cancelled',
    ar: 'ملغى',
    latin: false,
    refused: ['ملغي', 'تم الإلغاء'],
    note: 'Red; stays cancelled (the merchant books again on the site).',
  },
  {
    area: 'inbox',
    en: 'completed (a booking past its end)',
    ar: 'مكتمل',
    latin: false,
    refused: ['منتهٍ', 'منتهي'],
    note: 'Neutral; the sweep sets it once the end has passed, nobody by hand.',
  },
