...
export const GLOSSARY: readonly GlossaryRow[] = [
  ...
  { area: 'site', en: 'brand', ar: 'العلامة', latin: false, refused: ['البراند', 'الماركة'] },
  {
    ...
    latin: false,
    refused: ['الثيم', 'السمة'],
    note: 'How the site looks (spec 010): the colours, the typeface, the logo, the backgrounds. Its words are «العلامة», in the site settings.',
  },
  {
    area: 'site',
    en: 'brand colour (one of the five set by hand)',
    ar: 'لون العلامة',
    latin: false,
    refused: [],
    note: 'Primary, primary dark, accent, navy and ink; every other colour of the site is computed from them.',
  },
  {
    area: 'site',
    en: 'derived colour',
    ...
    latin: false,
    refused: ['لون فرعي'],
    note: 'Computed from a brand colour (the hover blue, the grey sections, the hairlines); never «درجة», which is the visibility score.',
  },
  {
    area: 'site',
    en: 'computed (a derived colour following its brand colour)',
    ar: 'محسوب',
    latin: false,
    refused: [],
  },
  {
    area: 'site',
    en: 'set by hand (a derived colour held at a value)',
    ar: 'مثبّت يدوياً',
    latin: false,
    refused: [],
  },
  {
    area: 'site',
    en: 'designed value (a derived colour as shipped)',
    ar: 'قيمة مصمّمة',
    latin: false,
    refused: [],
    note: 'The shipped hairline, secondary text and badge colours: kept until their brand colour changes.',
  },
  {
    area: 'site',
    en: 'contrast',
    ...
    latin: false,
    refused: [],
    note: 'Written as a ratio in Western digits, 4.5:1; the check under the colours reads every pair the site puts together.',
  },
  {
    area: 'site',
    en: 'does not follow (the appearance)',
    ar: 'لا يتبع المظهر',
    latin: false,
    refused: [],
    note: 'An image or file still holding the old colours after a change: the list on the Appearance screen.',
  },
  { area: 'site', en: 'typeface', ar: 'الخط', latin: false, refused: ['الفونت', 'نوع الخط'] },
  { area: 'site', en: 'logo', ar: 'الشعار', latin: false, refused: ['اللوجو', 'اللوغو'] },
  {
    area: 'site',
    en: 'background (a set: the colour, its text and its button)',
    ar: 'خلفية',
    latin: false,
    refused: ['نظام الألوان'],
    note: 'A section picks one by name; the text and the button on it come with it.',
  },
  { area: 'site', en: 'gradient', ar: 'تدرّج', latin: false, refused: ['جريدينت'] },
  {
    area: 'site',
    en: 'bloom (a soft patch of colour in a gradient)',
    ar: 'بقعة لون',
    latin: false,
    refused: ['فقاعة', 'دائرة لونية'],
  },
  {
    area: 'site',
    en: 'white button (white with primary text, on a dark background)',
    ar: 'الزر الأبيض',
    latin: false,
    refused: ['الزر المعكوس'],
    note: 'The call to action on a dark background, as on the bottom banner.',
  },
  {
    area: 'site',
    en: 'built from the brand (a background that follows the brand colours)',
    ar: 'من ألوان العلامة',
    latin: false,
    refused: [],
    note: 'White, light grey and deep sea: they change with the brand colours and cannot be deleted.',
  },
  {
    area: 'site',
    en: 'grain (the fine texture over a gradient)',
    ar: 'حبيبات',
    latin: false,
    refused: ['نويز', 'تشويش'],
  },
