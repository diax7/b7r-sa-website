...
export const GLOSSARY: readonly GlossaryRow[] = [
  ...
  { area: 'panel', en: 'notification', ar: 'تنبيه', latin: false, refused: ['إشعار', 'إشعارات'] },
  { area: 'panel', en: 'warnings (editorial)', ar: 'تنبيهات', latin: false, refused: ['تحذيرات'] },
  ...
  { area: 'site', en: 'section (of a page)', ar: 'قسم', latin: false, refused: ['سكشن'] },
  ...
  { area: 'catalogue', en: 'question (a FAQ entry)', ar: 'سؤال', latin: false, refused: ['مدخل'] },
  ...
  { area: 'blog', en: 'post', ar: 'مقال', latin: false, refused: ['تدوينة', 'مقالة'] },
  {
    ...
    latin: false,
    refused: ['تصنيف'],
    note: 'The blog section a post belongs to; plural «أقسام المدونة».',
  },
  ...
  { area: 'engine', en: 'backlog', ar: 'القائمة', latin: false, refused: ['متراكمات'] },
  ...
  {
    area: 'visibility',
    en: 'question (a buyer prompt)',
    ar: 'سؤال',
    latin: false,
    refused: ['موجه', 'موجهات', 'أمر نصي'],
  },
