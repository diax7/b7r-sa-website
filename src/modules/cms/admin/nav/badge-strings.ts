...
/**
 * The runs' and the drafts' sentences are the dashboard's own (`hand.failedRuns`,
 * `tiles.drafts`), as their numbers are its readers (ADR-058, ADR-059): one number, one
 * sentence, in the sidebar and on the dashboard alike.
 */
